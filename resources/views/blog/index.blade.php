                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="{{ route('blogs.create') }}" class="btn btn-success">Post New
                                            Blog</a>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($blogs as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="">
                                                                <a href="{{ asset('assets/blogFiles') . '/' . $item->feature_image }}?text=1"
                                                                    data-toggle="lightbox"
                                                                    data-title="{{ $item->title }}"
                                                                    data-gallery="gallery">
                                                                    <img src="{{ asset('assets/blogFiles') . '/' . $item->feature_image }}?text=1"
